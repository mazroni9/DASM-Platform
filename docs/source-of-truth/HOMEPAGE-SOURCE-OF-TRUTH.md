...
هذا الملف هو المرجع المعتمد لبنية الصفحة الرئيسية ومصادر الواجهة. أي تعديل لاحق يجب أن يلتزم به. **حدّث تاريخ «آخر تحديث» بعد أي تعديل بنيوي على الصفحة الرئيسية أو مصادر الواجهة.**

---

## ⚠️ قبل أي تعديل على الواجهة

1. **ارجع إلى هذا الملف** — `docs/source-of-truth/HOMEPAGE-SOURCE-OF-TRUTH.md`
