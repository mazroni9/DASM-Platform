                ...
                <div className="text-center py-12">
                    <div className="bg-white rounded-lg shadow-md p-8 max-w-md mx-auto">
                        ...
                        <p className="text-gray-500 mb-6">
                            لم تقم بإضافة أي سيارات بعد. ابدأ بإضافة سيارتك
                            الأولى للمشاركة في المزادات.
                        </p>
                        <Link
                            href="/add/Car"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {cars.map((car) => (
                        ...
                        >
                            ...
                            car.auctions[0].control_room_approved ? (
                                <Link
                                    className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-center inline-block"
                                    href={`#`}
                                    onClick={(e) => e.stopPropagation()}
                                    key={`link-${car.id}`}
                                >
