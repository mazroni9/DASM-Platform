          ...
          {cars.map((car) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mb-1">
                حالة المزاد: {getAuctionStatusTextAndIcon(car.auction_status).text}
              </p>
              ...
              {car.auction_status === "available" && (
                <Link
                  ...
                  key={`link-${car.id}`}
                >
                  <label>إضافة للمزاد</label>
                </Link>
              )}
              {car.auction_status !== "available" && car.auctions && car.auctions[0] && car.auctions[0].control_room_approved && (
                <Link
                  target="_blank"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-center inline-block"
