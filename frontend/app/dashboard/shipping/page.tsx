...
export default function ShippingPage() {
    ...
    const getCompanyConfig = (companyId: string) => {
        return shippingCompanies.find(c => c.id === companyId) || shippingCompanies[0];
    };
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm mt-1">إدارة وتتبع شحناتك بكل سهولة وأمان</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <div className="bg-gray-800/40 rounded-lg p-3 border border-gray-700/30">
                                ...
                                <p className="text-lg font-bold text-white mt-1">{selectedCompanies.length}</p>
                            </div>
                            <div className="bg-gray-800/40 rounded-lg p-3 border border-gray-700/30">
                                <div className="flex items-center gap-2">
                            ...
                            <div className="bg-gray-800/40 rounded-lg p-3 border border-gray-700/30">
                                ...
                                <p className="text-lg font-bold text-amber-400 mt-1">{shippingData.weight} كجم</p>
                            </div>
                            <div className="bg-gray-800/40 rounded-lg p-3 border border-gray-700/30">
                                <div className="flex items-center gap-2">
                                ...
                                <p className="text-lg font-bold text-cyan-400 mt-1">{shippingCost} ريال</p>
                            </div>
                        </div>
                    </div>
                ...
                >
                            ...
                            <div className="space-y-4">
                                <div className={cn(
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            <label className="text-sm text-gray-300 mb-2 block">الدولة</label>
                                            <select
                                                name="fromCountry"
                    ...
                    <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="text-sm text-gray-300 mb-2 block">الوزن (كجم)</label>
                                ...
                                <div>
                                    <label className="text-sm text-gray-300 mb-3 block">فئة الشحن</label>
                                    <div className="grid grid-cols-2 gap-2">
                                        {shippingCategories.map(category => {
                                            const CategoryIcon = category.icon;
                                            const isDisabled = Number(shippingData.weight) > category.maxWeight;
                                            const isSelected = shippingData.shippingCategory === category.id;
                                            
                                            return (
                                                <button
                                                    key={category.id}
                                                    type="button"
                                                    onClick={() => !isDisabled && setShippingData(prev => ({
                                                        ...prev,
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="text-xs opacity-80">حتى {category.maxWeight} كجم</div>
                                                        </div>
                                                    </div>
                                                </button>
                                            );
                            ...
                            {/* Dimensions */}
                            <div>
                                <label className="text-sm text-gray-300 mb-3 block">الأبعاد (سم)</label>
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        <label className="text-xs text-gray-400 mb-1 block">العرض</label>
                                        <div className="relative">
                                            <input
                                    ...
                                    <div>
                                        <label className="text-xs text-gray-400 mb-1 block">الارتفاع</label>
                                        <div className="relative">
                                            <input
                    ...
                    <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6">
                        ...
                        {selectedCompanies.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-300">لا توجد شركات شحن متاحة للوزن والمسافة المحددة</p>
                            </div>
                        ) : (
                            <div className="space-y-3">
                                {selectedCompanies.map(company => {
                                    const isSelected = shippingData.shippingCompany === company.id;
                                            ...
                                            <div className="flex items-start justify-between">
                                                <div className="flex items-start gap-3 flex-1">
                                                    <div className={cn(
                                                        ...
                                                        <Truck className={cn("w-4 h-4", companyConfig.color)} />
                                                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/40 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center py-3 border-b border-gray-700/50">
                                ...
                                <span className="text-white font-medium">{shippingData.weight} كجم</span>
                            </div>
