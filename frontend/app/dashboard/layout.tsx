        ...
        <div className="flex flex-col lg:flex-row gap-6 pt-4 lg:pt-6 items-start">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-6 space-y-4">
              ...
              {/* القائمة الرئيسية */}
              <div className="bg-card backdrop-blur-xl border border-border rounded-2xl p-4">
                <h3 className="text-sm font-bold text-foreground mb-3">القائمة الرئيسية</h3>
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isActive ? "bg-white/10" : "bg-border/30 group-hover:bg-background/10 group-hover:text-foreground"
                          )}
                        >
                          <Icon className="w-3 h-3" />
                        </div>
