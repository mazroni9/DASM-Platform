...
export default function AuctionControls({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-lg font-bold text-gray-900 mb-4">التحكم في المزاد</h2>
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className={`font-medium ${
            ...
            auctionStatus === 'paused' ? 'text-yellow-600' : 'text-red-600'
          }`}>
            {auctionStatus === 'active' ? 'نشط' :
             auctionStatus === 'paused' ? 'متوقف' : 'منتهي'}
          </span>
        </div>
      </div>
    </div>
