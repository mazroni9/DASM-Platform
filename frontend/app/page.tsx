        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="bg-card rounded-3xl border border-border/60 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center text-center px-6 py-8 md:px-7 md:py-9"
            >
              <div className="mb-4">
                <div className="w-16 h-16 md:w-18 md:h-18 rounded-2xl bg-primary flex items-center justify-center text-white">
                  {benefit.icon}
                </div>
              </div>
