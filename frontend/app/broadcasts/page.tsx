      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            شاهد المزادات المباشرة من معارض السيارات المختلفة عبر المملكة
          </p>
        </div>
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-1 text-sm text-gray-500 flex items-center">
                  ...
                  <span>
                    {venue.viewersCount} مشاهد {venue.isLive ? "الآن" : "متوقع"}
                  </span>
                </div>
        ...
        {activeAuction && (
          <div className="mt-8">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mt-4">
              <h2 className="text-2xl font-bold mb-4">المزاد الحالي</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1">
                  <div className="aspect-w-1 aspect-h-1 bg-gray-200 rounded-md overflow-hidden">
                    {activeAuction.car && activeAuction.car.main_image ? (
                      <img
                        src={activeAuction.car.main_image}
                        alt={activeAuction.car.name || "صورة السيارة"}
                  ...
                  {activeAuction.car && (
                    <>
                      <h3 className="text-xl font-semibold">
                        {activeAuction.car.make} {activeAuction.car.model}
                      </h3>
                      <p className="text-gray-600 mb-4">
                        {activeAuction.car.year} • {activeAuction.car.mileage}{" "}
                        كم
                      </p>

                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <p className="text-sm text-gray-500">سعر البداية</p>
                          <p className="font-semibold">
                            {activeAuction.starting_price} ريال
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">أعلى مزايدة</p>
                          <p className="font-semibold">
                      ...
                      {isLoggedIn ? (
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-md">
                          <p className="text-yellow-700">
                            يرجى تسجيل الدخول للمشاركة في المزاد
                          </p>
                        </div>
                      )}
                    </>
