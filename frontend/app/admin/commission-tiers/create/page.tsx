    ...
    <div className="min-h-screen bg-background text-foreground p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-card rounded-2xl border border-border shadow-lg p-6 mb-6">
            <div className="flex items-center space-x-4 space-x-reverse mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground">مرحباً بك في إنشاء فئة عمولة جديدة</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-muted rounded-2xl border border-border shadow-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2 space-x-reverse">
                ...
                <span className="text-muted-foreground">اختر اسمًا واضحًا يعبر عن نطاق الأسعار</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-muted-foreground">حدد نطاق الأسعار بدقة لتجنب التداخل</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-muted-foreground">العمولة التدريجية تناسب المنتجات متنوعة الأسعار</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-muted-foreground">يمكنك تعطيل الفئة لاحقًا إذا لزم الأمر</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-muted border border-border rounded-lg p-3">
                <div className="flex items-center space-x-2 space-x-reverse mb-2">
                  ...
                  <span className="text-foreground font-medium text-sm">تدريجية</span>
                </div>
              ...
              <div className="bg-muted border border-border rounded-lg p-3">
                <div className="flex items-center space-x-2 space-x-reverse mb-2">
                  ...
                  <span className="text-foreground font-medium text-sm">ثابتة</span>
                </div>
                <p className="text-muted-foreground text-xs">
          ...
          <div className="bg-muted rounded-2xl border border-border shadow-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2 space-x-reverse">
                ...
                <span className="text-muted-foreground">تأكد من عدم تداخل نطاقات الأسعار</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-muted-foreground">اختبر العمولة قبل التطبيق النهائي</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-muted-foreground">استخدم أسماء واضحة وسهلة التذكر</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
          ...
          {/* Quick Stats */}
          <div className="bg-muted rounded-2xl border border-border shadow-lg p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">معلومات سريعة</h3>
      ...
      <div className="mt-6 bg-muted rounded-2xl border border-border shadow-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-primary mb-2">هل تحتاج إلى إلهام؟</h3>
