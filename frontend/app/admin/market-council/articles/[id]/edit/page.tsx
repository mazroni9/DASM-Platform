...
export default function AdminMarketCouncilArticleEditPage() {
  ...
  const fetchArticle = async () => {
    ...
    try {
      ...
      const res = await api.get(`/api/admin/market-council/articles/${id}`);
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 py-6">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
              ...
              <p className="text-foreground/60 mt-2 text-sm">تعديل مقال مجلس السوق</p>
            </div>
            <div className="flex items-center gap-3 flex-wrap">
              <LoadingLink href="/admin/market-council/articles" className="bg-card border border-border hover:bg-border/60 px-4 py-2 rounded-xl flex items-center gap-2">
