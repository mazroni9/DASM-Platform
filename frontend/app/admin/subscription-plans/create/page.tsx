      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            إضافة خطة اشتراك جديدة إلى النظام مع الميزات المناسبة
          </p>
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 shadow-lg p-6 mb-6">
            <div className="flex items-center space-x-4 space-x-reverse mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">مرحباً بك في إنشاء خطة اشتراك جديدة</h2>
                <p className="text-gray-400 mt-1">
                  املأ النموذج أدناه لإنشاء خطة اشتراك جديدة في النظام
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-cyan-500/20 shadow-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2 space-x-reverse">
                ...
                <span className="text-cyan-300">اختر اسمًا يعكس قيمة ومستوى الخطة</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-cyan-300">حدد نوع المستخدم المستهدف بدقة</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-cyan-300">اضبط المدة والسعر بما يتناسب مع القيمة</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-cyan-300">يمكنك تعطيل الخطة لاحقًا إذا لزم الأمر</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-amber-500/5 border border-amber-500/10 rounded-lg p-3">
                <div className="flex items-center space-x-2 space-x-reverse mb-2">
                  ...
                  <span className="text-amber-300 font-medium text-sm">متميزة</span>
                </div>
                <p className="text-amber-200 text-xs">
                  أسعار أعلى مع ميزات متقدمة وشاملة
                </p>
              </div>
              ...
              <div className="bg-blue-500/5 border border-blue-500/10 rounded-lg p-3">
                <div className="flex items-center space-x-2 space-x-reverse mb-2">
                  ...
                  <span className="text-blue-300 font-medium text-sm">متوسطة</span>
                </div>
                <p className="text-blue-200 text-xs">
                  توازن بين السعر والميزات للاستخدام المتكرر
                </p>
              </div>
              ...
              <div className="bg-green-500/5 border border-green-500/10 rounded-lg p-3">
                <div className="flex items-center space-x-2 space-x-reverse mb-2">
                  ...
                  <span className="text-green-300 font-medium text-sm">أساسية</span>
                </div>
                <p className="text-green-200 text-xs">
                  مناسبة للمبتدئين والاستخدام المحدود
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-2xl border border-green-500/20 shadow-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2 space-x-reverse">
                ...
                <span className="text-green-300">استخدم تدرجًا منطقيًا في الأسعار</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-green-300">اختبر الخطة قبل الإطلاق النهائي</span>
              </div>
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="flex items-start space-x-2 space-x-reverse">
                <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-green-300">خطط لمسار ترقية المستخدمين</span>
              </div>
            </div>
          </div>
      ...
      <div className="mt-8 bg-gray-800/50 rounded-xl p-4">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-400">
            جاري إنشاء خطة اشتراك جديدة في النظام
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-300 text-sm">
              جرب هذه الأسماء الشائعة: "الأساسية"، "المتقدمة"، "الاحترافية"، "الشركات"
            </p>
          </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/20 p-4">
          <div className="flex items-center space-x-2 space-x-reverse mb-2">
            ...
            <span className="text-cyan-300 text-sm font-medium">استهداف دقيق</span>
          </div>
          <p className="text-cyan-200 text-xs">اختر نوع المستخدم المناسب لخطتك</p>
        </div>
        
        <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-xl border border-amber-500/20 p-4">
          <div className="flex items-center space-x-2 space-x-reverse mb-2">
            <DollarSign className="w-4 h-4 text-amber-400" />
            <span className="text-amber-300 text-sm font-medium">تسعير ذكي</span>
          </div>
          <p className="text-amber-200 text-xs">اضبط السعر بما يعكس القيمة المقدمة</p>
        </div>
        
        <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl border border-green-500/20 p-4">
          <div className="flex items-center space-x-2 space-x-reverse mb-2">
            <Calendar className="w-4 h-4 text-green-400" />
            <span className="text-green-300 text-sm font-medium">مدة مناسبة</span>
          </div>
          <p className="text-green-200 text-xs">اختر مدة تتناسب مع احتياجات المستخدمين</p>
        </div>
      </div>
    </div>
  );
