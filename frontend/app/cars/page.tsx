                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      handleFilterChange("sort_dir", sortDir);
                    }}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                    ...
                    <option value="year_desc">السنة: من الأحدث للأقدم</option>
                    <option value="year_asc">السنة: من الأقدم للأحدث</option>
                  </select>
                </div>
              </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-2 text-sm text-gray-600 mb-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{car.odometer?.toLocaleString()} كم</span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    {/* Active Auction Info */}
                    {car.auctions && car.auctions.length > 0 && (
                      <div className="bg-blue-50 p-3 rounded-md mb-4">
                        <p className="text-sm text-blue-800">
                          مزاد نشط - السعر الحالي:{" "}
                          {car.auctions[0].current_bid?.toLocaleString()} ريال
                        </p>
                      </div>
                    )}
            ...
            {cars.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  لم يتم العثور على سيارات تطابق معايير البحث الخاصة بك.
                </p>
              </div>
            )}
