  ...
  const fetchCarData = async () => {
    try {
      ...
      const response = await api.get(
        `/api/moderator/cars/${carId}/process-auction`,
      );
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await api.post(
        `/api/moderator/cars/${carId}/handle-auction`,
        {
          action: "approve",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            onClick={() => router.push("/moderator/cars")}
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {auction.reserve_price?.toLocaleString()} ريال
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <p className="text-gray-900">{auction.auction_type}</p>
              </div>
            </div>
          </div>
