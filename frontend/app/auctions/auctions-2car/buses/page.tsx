  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl font-serif text-center text-blue-300 mb-2">سوق الحافلات</h1>
        <p className="text-center text-gray-400 mb-10">يُعرض هنا فقط الحافلات المقبولة والتي لديها مزاد بحالة Active</p>
        ...
        {!loading && items.length === 0 ? (
          <p className="text-center text-gray-300">لا توجد حافلات متاحة حالياً.</p>
        ) : (
