      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">اللوحات الفنية الأصلية</h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                يضم معرض اللوحات الفنية الأصلية في منصتنا مجموعة منتقاة من أرقى وأندر القطع الفنية من مختلف العصور والثقافات، تشمل لوحات فنية أصلية، منحوتات متميزة، قطع خط عربي أصيلة، تحف أثرية، مخطوطات نادرة، وغيرها من القطع ذات القيمة التاريخية والفنية والاستثمارية العالية.
              </p>
              <p>
