        ...
        <div className="container mx-auto px-4 py-16">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              هذا المحتوى مخصص للأعضاء المعتمدين في مزادات VIP الخاصة. يرجى طلب
              دعوة للانضمام للوصول إلى المنتجات الحصرية.
            </p>
            <LoadingLink
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="relative h-[400px] md:h-[500px] bg-gray-100">
                ...
                <button
                  onClick={() =>
                    setActiveImage((prev) =>
                      prev === (itemDetails.images?.length || 1) - 1
                        ? 0
                        : prev + 1
                    )
                  }
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="bg-purple-50 p-3 rounded-lg flex items-start mb-6">
                ...
                <div className="text-sm text-purple-800">
                  ...
                  <p>
                    سيتم التواصل معك مباشرة من قبل مستشار المزادات الخاص بك بعد
                    المزايدة لتأكيد العملية وترتيب المعاينة.
                  </p>
                </div>
              </div>
