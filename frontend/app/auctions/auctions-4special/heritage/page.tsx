...
export default function HeritagePage() {
  ...
  const categories = [
    ...
    { id: 'historic-weapons', name: 'الأسلحة التراثية', icon: Swords, description: 'سيوف، خناجر، بنادق قديمة، ومقتنيات حربية أو نياشين ملكية' },
    { id: 'rare-manuscripts', name: 'المخطوطات والوثائق النادرة', icon: FileText, description: 'مصاحف قديمة، وثائق عثمانية أو نجدية، رسائل بخط اليد من عصور ماضية' },
    { id: 'coins-stamps', name: 'العملات والطوابع النادرة', icon: Coins, description: 'عملات معدنية وورقية، وطوابع ذات قيمة تاريخية' },
    { id: 'musical-instruments', name: 'الآلات الموسيقية النادرة', icon: Music, description: 'بيانو، عود نادر، كمان أثري، آلات موسيقية موقعة من فنانين' },
  ...
  const featuredItems = [
    ...
    {
      id: 7,
      title: 'سيف عربي مرصع بالفضة',
      category: 'historic-weapons',
      description: 'سيف عربي أصيل مزخرف ومرصع بالفضة، صُنع للأمراء في القرن التاسع عشر، حالة نادرة وحفظ ممتاز',
      ...
      currentBid: 48500,
      bidCount: 15,
      image: '/rare-items/arabian-sword.jpg',
      hasCertificate: true,
    },
    {
      id: 8,
      title: 'مخطوطة قرآنية نادرة',
      category: 'rare-manuscripts',
      description: 'مخطوطة قرآنية مذهبة وملونة بخط النسخ الجميل، مزينة بزخارف إسلامية دقيقة ورسومات هندسية بديعة',
      origin: 'الدولة العثمانية',
      ...
      currentBid: 78000,
      bidCount: 9,
      image: '/rare-items/quran-manuscript.jpg',
      hasCertificate: true,
    },
    {
      id: 9,
      title: 'مجموعة عملات ذهبية إسلامية',
      category: 'coins-stamps',
      description: 'مجموعة نادرة من العملات الذهبية الإسلامية من العصر العباسي والأموي، حالة ممتازة مع حفظ التفاصيل',
      origin: 'الدولة الإسلامية',
      age: 'القرن الثامن الميلادي',
      condition: 'ممتازة',
      price: 60000,
      currentBid: 65000,
      bidCount: 18,
      image: '/rare-items/islamic-coins.jpg',
      hasCertificate: true,
    },
    {
      id: 10,
      title: 'عود خشبي مطعم بالصدف',
      category: 'musical-instruments',
      description: 'عود خشبي نادر من خشب الجوز المطعم بالصدف والعاج، صناعة يدوية دمشقية أصيلة، صوت رنان وجودة عالية',
      origin: 'سوريا',
      ...
      currentBid: 32000,
      bidCount: 11,
      image: '/rare-items/damascus-oud.jpg',
      hasCertificate: true,
    },
    {
      id: 3,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* بانر علوي مع تغيير اللون من البني إلى الأزرق المميز */}
      <div className="relative h-96 bg-gradient-to-r from-blue-700 via-indigo-600 to-purple-700 overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center relative z-10 py-16">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mb-8 mx-auto">
              سوق موثوق للتحف والقطع النادرة الأصلية ذات القيمة التاريخية والثقافية، يشمل الأسلحة التراثية، المخطوطات، العملات النادرة والآلات الموسيقية الأثرية
            </p>
          </div>
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-lg font-bold group-hover:text-indigo-600 transition line-clamp-1">{item.title}</h3>
                  <div className="text-xs bg-indigo-50 text-indigo-600 px-2 py-1 rounded-full">
                ...
                <div className="flex justify-between items-center border-t pt-3">
                  <div>
                    ...
                    <div className="text-lg font-bold text-indigo-600">{formatPrice(item.currentBid)} ريال</div>
                  </div>
