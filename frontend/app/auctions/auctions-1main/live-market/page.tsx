...
import { ChevronRight, Clock, BellOff, Timer, Video, RadioIcon } from 'lucide-react';
    ...
    async function fetchAuctions() {
      ...
      try {
        ...
        if (response.data.data || response.data.data) {
          ...
          console.log("- current_car:", current_car);
          console.log("- current_car type:", typeof current_car);
          console.log("- current_car is null:", current_car === null);
          console.log("- liveAuctions:", liveAuctions);
          console.log("- completedAuctions:", completedAuctions);
