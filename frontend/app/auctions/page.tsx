...
export default function AuctionsPage() {
  ...
  const auctionsMain: Auction[] = [
    ...
    },
    {
      ...
      description:
        'فرصتك الأخيرة لصفقات سريعة. أعلى سعر يفوز عند انتهاء الوقت.',
      icon: Timer,
      color: 'text-primary',
      bgColor: 'bg-card',
      borderColor: 'border-border',
  ...
  const auctionsGeneral: Auction[] = [
    {
      ...
      description:
        'أجهزة إلكترونية متنوعة من هواتف وأجهزة لوحية وحواسيب',
      icon: Smartphone,
      color: 'text-primary',
      bgColor: 'bg-card',
      borderColor: 'border-border',
  ...
  const auctionsBig: Auction[] = [
    {
      ...
      slug: 'auctions-6big',
      description:
        'المنصة الوطنية الأولى للمزادات في المملكة العربية السعودية',
      icon: Store,
      color: 'text-primary',
      bgColor: 'bg-card',
      borderColor: 'border-border',
