  ...
  useEffect(() => {
    async function fetchWalletData() {
      ...
      try {
        ...
        if (walletResponse.data && walletResponse.data.status === "success") {
            ...
            const processedTransactions = formattedTransactions.map(
              (transaction, index) => {
                ...
                return {
                  ...
                  balance: transaction.balance || runningBalance,
                };
              },
            );
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                        ...
                        >
                          {transaction.amount > 0 ? "+" : ""}
                          {transaction.amount.toLocaleString("ar-EG")} ريال
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-foreground/50">
                        ...
                        {transaction.balance && (
                          <div className="flex items-center gap-1">
                            ...
                            <span>
                              الرصيد:{" "}
                              {transaction.balance.toLocaleString("ar-EG")} ريال
                            </span>
                          </div>
                        )}
                      </div>
