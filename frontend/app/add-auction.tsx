  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto mb-10">
      <div className="border-b pb-4 mb-6">
        <h1 className="text-2xl font-bold text-gray-800">إنشاء مزاد جديد</h1>
        <p className="text-gray-600 mt-1">
          يرجى تعبئة جميع البيانات المطلوبة لإنشاء مزادك - سيتم مراجعته من قبل
          المشرف
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                سيتم مراجعة مزادك من قبل المشرف الذي سيحدد سعر الافتتاح. لا يمكن
                أن يكون سعر الافتتاح أقل من 90% من أقل سعر مقبول.
              </p>
            </div>
          </div>
        </div>
