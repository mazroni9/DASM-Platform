...
import ZatcaSettings from "@/components/shared/ZatcaSettings";
...
export default function ExhibitorDashboard() {
  ...
  async function loadZatcaSettings() {
    const response = await api.get('api/exhibitor/zatcaSettings');
        ...
        <main className="flex-1 min-h-0 overflow-y-auto">
          ...
          <div className="relative px-3 md:px-6 py-4">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <ZatcaSettings 
                settingsEndpoint="api/exhibitor/zatcaSettings" 
                verifyEndpoint="api/exhibitor/zatcaVerify" 
