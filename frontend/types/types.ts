...
export const UserRoleHelpers = {
    ...
    canManageAuctions: (role: UserRole): boolean => {
        return [UserRole.ADMIN, UserRole.MODERATOR, UserRole.VENUE_OWNER].includes(role);
    },
    ...
    canManageVenues: (role: UserRole): boolean => {
        return [UserRole.ADMIN, UserRole.VENUE_OWNER].includes(role);
    },

    canAccessInvestments: (role: UserRole): boolean => {
        return [UserRole.ADMIN, UserRole.INVESTOR].includes(role);
    },
