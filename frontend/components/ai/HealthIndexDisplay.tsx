...
export default function HealthIndexDisplay({
    ...
    const [report, setReport] = useState<CarHealthReport | null>(
        initialReport || null
    );
    const [isLoading, setIsLoading] = useState<boolean>(
        externalLoading || !initialReport
    );
    ...
    const getSeverityBadge = (severity: "low" | "medium" | "high") => {
        ...
        return (
            <span
                className={`${styles[severity]} text-xs px-2 py-0.5 rounded-full`}
            >
                {labels[severity]}
            </span>
        );
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-4">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="text-lg text-gray-400 mr-1">
                                /100
                            </span>
                    ...
                    <div className="flex flex-col items-end">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="font-semibold">
                                {report.estimatedLifeExpectancy.years} سنوات
                            </span>
                            <span className="mx-1 text-gray-400">|</span>
                            <span className="font-semibold">
                                {report.estimatedLifeExpectancy.kilometers.toLocaleString()}{" "}
                                كم
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                        <div>
                            ...
                            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${report.healthIndex.exterior}%`,
                                    }}
                                ></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${report.healthIndex.engine}%`,
                                    }}
                                ></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${report.healthIndex.interior}%`,
                                    }}
                                ></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${report.healthIndex.suspension}%`,
                                    }}
                                ></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex justify-between text-sm mb-1">
                                ...
                                <span className="font-medium">
                                    {report.healthIndex.electronics}%
                                </span>
                            </div>
                            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        width: `${report.healthIndex.electronics}%`,
                                    }}
                                ></div>
                            </div>
                        </div>
                ...
                {showDetails && report.recommendedChecks.length > 0 && (
                    <div>
                        <h4 className="text-sm font-semibold text-gray-700 mb-2 flex items-center">
                            <Wrench className="h-4 w-4 ml-1 text-blue-500" />
                            الفحوصات الموصى بها
                        </h4>
                        <ul className="bg-blue-50 rounded p-2">
                            {report.recommendedChecks.map((check, index) => (
                                <li
                                    key={index}
                                    className="text-sm mb-1 flex items-start"
                                >
