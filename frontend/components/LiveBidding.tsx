...
export default function LiveBidding({ itemId, currentPrice }: LiveBiddingProps) {
              ...
              >
                <div className="flex items-center">
                  <div className={`
                    ...
                    ${bid.source === 'online' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600'}
                  `}>
                    <User size={16} />
                  </div>
                  <div>
                ...
                <div className="text-center">
                  <div className={`text-lg font-bold ${bid.is_winning ? 'text-yellow-600' : 'text-gray-800'}`}>
        ...
        <div className="mt-3 p-2 border-t border-gray-100">
          <div className="flex justify-between items-center">
            <div className="flex items-center text-gray-500 text-sm">
              ...
              <span>المزايدون النشطون: <span className="font-medium">18</span></span>
            </div>
