...
// Define delivery method interface
...
export default function WatchAuctionRequestPage() {
    ...
    const approvedBrands: Brand[] = [
        ...
        },
        {
            ...
            models: ["Royal Oak", "Royal Oak Offshore"],
        },
        ...
        {
            name: "Cartier",
            models: ["Santos", "Tank", "Ballon Bleu", "Panthère"],
        },
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6 md:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <p className="text-sm text-gray-600 italic">
                            سيتم تحديد سعر الافتتاح من قبل غرفة التحكم (الكنترول
                            روم) بناءً على تقييم الساعة.
                        </p>
                ...
                <div className="max-w-4xl mx-auto bg-blue-50 rounded-xl p-4 flex items-start">
                    ...
                    <div>
                        ...
                        <ul className="text-blue-700 space-y-1 text-sm">
                            <li>
                                • قم بتصوير الساعة من جميع الزوايا بضوء جيد
                                ومناسب
                            </li>
                            <li>
                                • أضف صورًا واضحة للإبزيم والمينا والرقم المرجعي
                            </li>
                            <li>• كن صادقًا في وصف الحالة والخدوش إن وجدت</li>
                            <li>
                                • أرفق شهادات الفحص والأوراق الرسمية إن وجدت
                            </li>
                            <li>
                                • حدد سعرًا تنافسيًا مناسبًا لحالة وسنة إنتاج
                                الساعة
                            </li>
                        </ul>
                    </div>
