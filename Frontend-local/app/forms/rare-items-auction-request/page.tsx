...
export default function RareItemAuctionRequestPage() {
    const [formData, setFormData] = useState<RareItemFormData>({
        itemName: "",
        category: "",
        yearProduced: "",
        origin: "",
    ...
    const conditions = [
        {
            value: "excellent",
            label: "ممتازة (حالة استثنائية مع حفظ كامل للتفاصيل)",
        },
        {
            value: "very_good",
            label: "جيدة جدًا (حالة ممتازة مع آثار استخدام طفيفة)",
        },
        {
            value: "good",
            label: "جيدة (حالة جيدة مع بعض علامات الاستخدام أو الترميم)",
        },
        {
            value: "fair",
            label: "متوسطة (تحتاج لبعض الترميم وبها علامات تقادم واضحة)",
        },
        {
            value: "poor",
            label: "ضعيفة (بحاجة لترميم كبير، لكن ذات قيمة تاريخية)",
        },
    ];
    ...
    const deliveryMethods = [
        {
            value: "platform",
            label: "خدمة توصيل المنصة المتخصصة (رسوم إضافية)",
        },
            ...
            <div className="bg-gradient-to-r from-amber-800 to-amber-600 py-6">
                <div className="container mx-auto px-4">
                    ...
                    <h1 className="text-3xl font-bold text-white">
                        تسجيل قطعة نادرة للبيع
                    </h1>
                    <p className="text-white/80 mt-2">
                        سجل قطعتك النادرة بكافة التفاصيل لعرضها في منصة Heritage
                        للمقتنيات الفاخرة
                    </p>
                </div>
            </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-blue-700 text-sm">
                                    نرحب بالقطع النادرة ذات القيمة التاريخية
                                    والفنية. جميع القطع ستخضع للتحقق من الأصالة
                                    والموثوقية قبل العرض للبيع. يرجى تقديم أكبر
                                    قدر ممكن من المعلومات الدقيقة لتسهيل عملية
                                    التحقق.
                                </p>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                سيتم استخدام هذا كأساس للسعر الافتتاحي للمزاد
                            </p>
                        </div>
                                        ...
                                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 mb-1">
                                                    انقر لرفع ملف الشهادة
                                                </p>
                                                <p className="text-sm text-gray-500">
                                                    PDF أو صورة واضحة للشهادة
                                                </p>
                                            </label>
                                        </div>
                        ...
                        <div>
                            ...
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-gray-500">
                                        يرجى رفع صور واضحة من جميع الزوايا (حتى
                                        10 صور)
                                    </p>
                                </label>
                            </div>
                        ...
                        <div className="bg-amber-50/50 p-4 rounded-lg border border-amber-100">
                            ...
                            <ul className="list-disc mr-5 space-y-1 text-sm text-amber-700">
                                <li>
                                    قدم وصفًا دقيقًا وشاملًا للقطعة، بما في ذلك
                                    التفاصيل التي تميزها.
                                </li>
                                <li>
                                    أرفق صورًا واضحة للقطعة من جميع الزوايا
                                    والتفاصيل المهمة والنقوش.
                                </li>
                                <li>
                                    قدم معلومات موثقة عن تاريخ القطعة ومصدرها
                                    إذا كانت متوفرة.
                                </li>
                                <li>
                                    حدد حالة القطعة بدقة، بما في ذلك أي علامات
                                    استخدام أو ترميم.
                                </li>
                                <li>
                                    احرص على رفع أي وثائق أو شهادات تثبت أصالة
                                    القطعة.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="flex items-start">
                            ...
                            >
                                أقر بصحة جميع المعلومات المقدمة وأن القطعة أصلية
                                ومملوكة لي بشكل قانوني. أوافق على{" "}
                                <Link
                                    href="/terms"
