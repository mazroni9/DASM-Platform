...
// Using correct params type based on Next.js 15 documentation
export default function handler(
    request: NextApiRequest,
    response: NextApiResponse
) {
    // تأكد من أن الطلب هو GET
    ...
    try {
        ...
        // Ensure id is a string, not an array, and handle undefined case
        const itemId = Array.isArray(id) ? id[0] : id || "";

        // Check if itemId is empty
        if (!itemId) {
            return response.status(400).json({ error: "معرف المنتج مطلوب" });
        }
        ...
        `,
                ...
                bids: [
                    ...
                    },
                    {
                        amount: 1300000,
                        user: "العميل #2754",
                        date: "2025-06-19 10:45",
                    },
                    {
                        amount: 1275000,
                        user: "العميل #9183",
                        date: "2025-06-18 21:17",
                    },
                    {
                        amount: 1250000,
                        user: "العميل #4127",
                        date: "2025-06-18 09:32",
                    },
                ],
                authenticityChecks: [
                ...
                similarItems: [
                    {
                        id: 101,
                        title: "بنتلي كونتيننتال GT",
                        price: 950000,
                        category: "سيارات",
                    },
                    {
                        id: 102,
                        title: "رولز رويس فانتوم",
                        price: 1750000,
                        category: "سيارات",
                    },
                    {
                        id: 103,
                        title: "لمبورغيني أفنتادور",
                        price: 1450000,
                        category: "سيارات",
                    },
                ],
            ...
            "2": {
                ...
                description:
                    "ساعة Patek Philippe Nautilus إصدار محدود رقم 18/25 مصنوعة من الذهب الوردي، مع توثيق من الشركة الأم",
                fullDescription: `
...
لم يتم ارتداء الساعة إلا نادرًا، وتم الاحتفاظ بها في خزنة خاصة معظم الوقت. جميع الأختام والملصقات الأصلية موجودة، والساعة خالية من أي خدوش أو علامات استخدام واضحة.
        `,
                ...
                bids: [
                    {
                        amount: 880000,
                        user: "العميل #3651",
                        date: "2025-06-21 09:14",
                    },
                    {
                        amount: 878000,
                        user: "العميل #8246",
                        date: "2025-06-20 15:32",
                    },
                    {
                        amount: 875000,
                        user: "العميل #1973",
                ...
                similarItems: [
                    {
                        id: 201,
                        title: "ساعة Audemars Piguet Royal Oak",
                        price: 650000,
                        category: "ساعات",
                    },
                    {
                        id: 202,
                        title: "ساعة Richard Mille RM 35-02",
                        price: 1250000,
                        category: "ساعات",
                    },
                    {
                        id: 203,
                        title: "ساعة Rolex Daytona",
                        price: 450000,
                        category: "ساعات",
                    },
                ],
            ...
            "3": {
                ...
                description:
                    "طقم ألماس فاخر من VAN CLEEF يتكون من عقد وسوار وخاتم، إجمالي قيراط 18.5 بشهادة GIA",
                fullDescription: `
...
الطقم كان هدية لشخصية اجتماعية مرموقة، ولم يتم ارتداؤه سوى في مناسبتين رسميتين فقط. تم الاحتفاظ به في خزنة آمنة، ويُباع الآن كاستثمار مع توقعات بارتفاع قيمته بمرور الوقت.
        `,
                ...
                bids: [
                    {
                        amount: 655000,
                        user: "العميل #6214",
                        date: "2025-06-22 11:36",
                    },
                    {
                        amount: 650000,
                        user: "العميل #9427",
                        date: "2025-06-21 17:08",
                    },
                ],
                authenticityChecks: [
                ...
                similarItems: [
                    {
                        id: 301,
                        title: "خاتم ألماس كارتييه",
                        price: 350000,
                        category: "مجوهرات",
                    },
                    {
                        id: 302,
                        title: "سوار بولغاري سيربنتي",
                        price: 280000,
                        category: "مجوهرات",
                    },
                    {
                        id: 303,
                        title: "عقد تيفاني بالألماس الأزرق",
                        price: 520000,
                        category: "مجوهرات",
                    },
                ],
        ...
        if (!item) {
            return response.status(404).json({ error: "المنتج غير موجود" });
        }
