...
// Define proper type for the product
interface Product {
    id: string | number;
    title: string;
    description: string;
        ...
        const fetchGreenProducts = async () => {
            try {
                ...
                const response = await fetch(
                    "/api/items?category=green&limit=8&sort=newest"
                );
    ...
    const features = [
        {
            title: "صديقة للبيئة",
            description:
                "منتجات مستدامة تقلل من البصمة الكربونية وتحافظ على الموارد الطبيعية",
        },
        {
            title: "موفرة للطاقة",
            description:
                "تساعد على تقليل استهلاك الطاقة وخفض فواتير الكهرباء والمياه",
        },
        {
            title: "معتمدة بيئيًا",
            description:
                "منتجات مفحوصة ومعتمدة من جهات متخصصة في المعايير البيئية",
        },
    ];

    // دالة لاستخراج معلومات إضافية من JSON
    const extractAdditionalInfo = (product: Product) => {
        try {
        ...
        <div className="container mx-auto p-4 py-8">
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl shadow-lg overflow-hidden mb-10">
                <div className="p-8 text-white">
                    <h2 className="text-3xl font-bold mb-3">
                        منتجات مستدامة لحياة أكثر خضرة
                    </h2>
                    <p className="text-xl opacity-90 mb-6">
                        مجموعة متنوعة من المنتجات الصديقة للبيئة التي تساعد على
                        تقليل التأثير البيئي وتوفير الطاقة والموارد
                    </p>
            ...
            <div className="mb-10">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <Link
                                            href={`/auctions/auctions-general/green/${product.id}`}
                ...
                <div className="mt-6 text-center">
                    <Link
                        href="/auctions/auctions-general/green/all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                {features.map((feature, index) => (
                    <div
                        key={index}
                        className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-green-400"
                    >
            ...
            <div className="bg-green-50 rounded-xl shadow-md p-8 border-r-4 border-green-500 mb-10">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-2xl font-bold mb-4 text-center">
                        هل لديك منتجات صديقة للبيئة ترغب في بيعها؟
                    </h2>
                    <p className="text-gray-600 mb-6 text-center">
                        يمكنك المساهمة في نشر ثقافة الاستدامة من خلال بيع
                        منتجاتك الخضراء ووصولها لمن يبحث عن أسلوب حياة صديق
                        للبيئة.
                    </p>
                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            كيف أتأكد من المعايير البيئية للمنتجات؟
                        </h3>
                        <p className="text-gray-600">
                            جميع المنتجات في سوق المنتجات الخضراء تخضع لتقييم
                            بيئي وتحمل شهادات معتمدة. يمكنك الاطلاع على تفاصيل
                            الشهادات البيئية في صفحة كل منتج.
                        </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            هل المنتجات المستعملة تعتبر خضراء؟
                        </h3>
                        <p className="text-gray-600">
                            نعم، إعادة استخدام المنتجات يعتبر من أهم ممارسات
                            الاستدامة. المنتجات المستعملة تقلل من استهلاك
                            الموارد وتقليل النفايات، مما يجعلها خيارًا صديقًا
                            للبيئة.
                        </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            هل تقدمون خدمات تركيب للأنظمة الخضراء؟
                        </h3>
                        <p className="text-gray-600">
                            نعم، نوفر خدمات تركيب للعديد من المنتجات مثل أنظمة
                            الطاقة الشمسية وأنظمة ترشيد المياه. يمكنك الاستفسار
                            عن خدمات التركيب المتاحة عند الشراء.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-10 bg-green-50 p-6 rounded-xl border border-green-200">
                <h2 className="text-xl font-bold mb-4 text-green-800">
                    فوائد استخدام المنتجات الخضراء
                </h2>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>
                        تقليل التأثير البيئي والمساهمة في الحفاظ على كوكب الأرض
                    </li>
                    <li>توفير في تكاليف الطاقة والمياه على المدى الطويل</li>
                    <li>
                        الحد من التعرض للمواد الكيميائية الضارة في المنتجات
                        التقليدية
                    </li>
