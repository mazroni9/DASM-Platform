        ...
        const fetchElectronicsProducts = async () => {
            try {
                ...
                const response = await fetch(
                    "/api/items?category=electronics&limit=8&sort=newest"
                );
    ...
    const features = [
        {
            title: "ضمان الأجهزة",
            description:
                "جميع الأجهزة مفحوصة وتأتي مع ضمان لمدة شهر ضد عيوب المصنع",
        },
        {
        ...
        },
        {
            ...
            description:
                "نضمن مسح جميع البيانات الشخصية من الأجهزة قبل إعادة بيعها",
        },
    ];
        ...
        <div className="container mx-auto p-4 py-8">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg overflow-hidden mb-10">
                <div className="p-8 text-white">
                    <h2 className="text-3xl font-bold mb-3">
                        أجهزة إلكترونية حديثة بأسعار معقولة
                    </h2>
                    <p className="text-xl opacity-90 mb-6">
                        نقدم مجموعة متنوعة من الأجهزة الإلكترونية المستعملة
                        والمجددة بضمان وجودة عالية
                    </p>
            ...
            <div className="mb-10">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <Link
                                            href={`/auctions/auctions-general/electronics/${product.id}`}
                ...
                <div className="mt-6 text-center">
                    <Link
                        href="/auctions/auctions-general/electronics/all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                {features.map((feature, index) => (
                    <div
                        key={index}
                        className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-blue-400"
                    >
            ...
            <div className="bg-blue-50 rounded-xl shadow-md p-8 border-r-4 border-blue-500 mb-10">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-2xl font-bold mb-4 text-center">
                        هل لديك أجهزة إلكترونية ترغب في بيعها؟
                    </h2>
                    <p className="text-gray-600 mb-6 text-center">
                        يمكنك الآن بيع أجهزتك الإلكترونية التي لم تعد بحاجة لها
                        بكل سهولة. نوفر لك منصة آمنة وندعمك في عملية البيع من
                        البداية إلى النهاية.
                    </p>
                ...
                <div className="space-y-4">
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            كيف أتأكد من حالة الجهاز قبل الشراء؟
                        </h3>
                        <p className="text-gray-600">
                            نوفر تقرير فحص تفصيلي لكل جهاز، يشمل اختبارات الأداء
                            ونسبة صحة البطارية وحالة الشاشة. كما يمكنك طلب تجربة
                            الجهاز قبل الشراء للتأكد من حالته.
                        </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            هل تقدمون ضمانًا على الأجهزة المستعملة؟
                        </h3>
                        <p className="text-gray-600">
                            نعم، جميع الأجهزة الإلكترونية تأتي مع ضمان لمدة شهر
                            ضد عيوب المصنع. يمكن أيضًا شراء ضمان إضافي لبعض
                            الأجهزة مقابل رسوم إضافية.
                        </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-sm p-5">
                        <h3 className="font-bold text-lg mb-2">
                            كيف تضمنون خصوصية بياناتي عند بيع جهازي؟
                        </h3>
                        <p className="text-gray-600">
                            نستخدم برامج متطورة لمسح البيانات بشكل آمن من جميع
                            الأجهزة، ونقدم شهادة حذف البيانات مع كل جهاز. يمكنك
                            أيضًا حضور عملية إعادة ضبط المصنع للجهاز.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-10 bg-blue-50 p-6 rounded-xl border border-blue-200">
                <h2 className="text-xl font-bold mb-4 text-blue-800">
                    نصائح عند شراء الأجهزة الإلكترونية المستعملة
                </h2>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    <li>تحقق من عمر الجهاز وتاريخ إصداره قبل الشراء</li>
                    <li>
                        اطلب الاطلاع على تقرير حالة البطارية للأجهزة المحمولة
                    </li>
