...
export default function FurnitureMarketPage() {
  ...
  useEffect(() => {
    const fetchFurnitureProducts = async () => {
      try {
        ...
        const response = await fetch('/api/items?category=furniture&limit=8&sort=newest');
  ...
  const features = [
    ...
    {
      title: "ضمان الرضا",
      description: "إمكانية الإرجاع خلال 7 أيام في حال عدم مطابقة المنتج للوصف"
    }
  ];
  ...
  return (
    <div className="container mx-auto p-4 py-8">
      <div className="mb-6 flex justify-between items-center">
        ...
        <h1 className="text-3xl font-bold text-center text-amber-700">سوق الأثاث المنزلي</h1>
      ...
      <div className="bg-gradient-to-r from-amber-500 to-orange-400 rounded-xl shadow-lg overflow-hidden mb-10">
        <div className="p-8 text-white">
          <h2 className="text-3xl font-bold mb-3">أثاث منزلي راقي بأسعار معقولة</h2>
          <p className="text-xl opacity-90 mb-6">
            تسوق من تشكيلة واسعة من الأثاث المنزلي المستعمل بحالة ممتازة وبأسعار مناسبة
          </p>
      ...
      {/* المنتجات المميزة */}
      <div className="mb-10">
        <h2 className="text-2xl font-bold mb-6 border-b pb-2">قطع الأثاث المميزة</h2>
                  ...
                  <div className="p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="bg-amber-100 text-amber-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
                        {additionalInfo.roomType || "أثاث منزلي"}
                      </span>
                    </div>
                    <p className="text-gray-600 text-sm mb-3 line-clamp-2">{product.description}</p>
                    {additionalInfo.dimensions && (
                      <p className="text-gray-500 text-xs mb-2">
                        <span className="font-medium">الأبعاد:</span> {additionalInfo.dimensions}
                      </p>
                    )}
                    {additionalInfo.materials && (
                      <p className="text-gray-500 text-xs mb-2">
                        <span className="font-medium">المواد:</span> {additionalInfo.materials}
                      </p>
                    )}
                    <div className="flex justify-between items-center mt-3">
                      <span className="text-xl font-bold text-amber-600">{product.current_price} ريال</span>
                      <span className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded">
                        الحالة: {product.condition || "مستعمل"}
                      </span>
                    </div>
                    <Link 
                      href={`/auctions/auctions-general/furniture/${product.id}`}
        ...
        <div className="mt-6 text-center">
          <Link 
            href="/auctions/auctions-general/furniture/all"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {features.map((feature, index) => (
          <div key={index} className="bg-white rounded-lg shadow-sm p-6 border-t-4 border-amber-400">
            <h3 className="font-bold text-lg mb-2 text-amber-700">{feature.title}</h3>
      ...
      <div className="bg-gray-50 rounded-xl shadow-md p-8 border-r-4 border-amber-500 mb-10">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-4 text-center">هل لديك أثاث منزلي ترغب في بيعه؟</h2>
          <p className="text-gray-600 mb-6 text-center">
            يمكنك الآن بيع قطع الأثاث المنزلي التي لم تعد بحاجة لها بكل سهولة. نوفر لك منصة آمنة ونصل بك إلى آلاف المشترين المهتمين.
          </p>
      ...
      <div className="mt-10">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h3 className="font-bold text-lg mb-2">كيف يتم تحديد أسعار قطع الأثاث؟</h3>
            <p className="text-gray-600">
              يتم تحديد الأسعار بناءً على عدة عوامل منها: حالة القطعة، عمرها، الماركة، المواد المستخدمة، والسعر في السوق. نحن نضمن أسعاراً عادلة للبائع والمشتري.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h3 className="font-bold text-lg mb-2">هل يمكنني معاينة قطع الأثاث قبل الشراء؟</h3>
            <p className="text-gray-600">
              نعم، يمكنك تحديد موعد لمعاينة قطعة الأثاث قبل اتخاذ قرار الشراء. نوفر صوراً تفصيلية وأوصافاً دقيقة، لكن المعاينة الشخصية متاحة في معظم الحالات.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-5">
            <h3 className="font-bold text-lg mb-2">ما هي خيارات التوصيل المتاحة؟</h3>
            <p className="text-gray-600">
              نوفر خدمة توصيل إلى المنزل بتكلفة إضافية تعتمد على المسافة وحجم القطعة. كما يمكن الاتفاق على الاستلام الشخصي مع البائع، أو استخدام شركات شحن خارجية.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 bg-amber-50 p-6 rounded-xl border border-amber-200">
        <h2 className="text-xl font-bold mb-4 text-amber-800">نصائح عند شراء الأثاث المستعمل</h2>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <li>خذ القياسات بدقة وتأكد من مناسبة القطعة للمساحة المتوفرة لديك</li>
        </ul>
      </div>
    </div>
  );
