...
const artworksData: Artwork[] = [
    {
        ...
        year: "2018",
        description:
            "لوحة زيتية تصور الصحراء العربية بألوان دافئة ومناظر طبيعية خلابة، تُظهر اللوحة جمال الكثبان الرملية وقت غروب الشمس، مع قافلة من الإبل في المشهد البعيد. استخدم الفنان تقنيات متميزة في مزج الألوان وإظهار تدرجات الضوء والظل لإضفاء عمق استثنائي على المشهد.",
        category: "لوحات",
        medium: "زيت على قماش",
        ...
        bids: [
            ...
            },
            {
                amount: "27,000",
                bidder: "المشتري #1856",
                time: "2025-07-12 10:15",
            },
            {
                amount: "26,000",
                bidder: "المشتري #3298",
                time: "2025-07-11 18:40",
            },
            {
                amount: "25,500",
                bidder: "المشتري #2175",
                time: "2025-07-11 09:22",
            },
            {
                amount: "25,000",
                bidder: "المشتري #4327",
        ...
        history:
            "رُسمت هذه اللوحة بتكليف خاص للمعرض السنوي للفنون العربية في دبي عام 2018، وحصلت على جائزة لجنة التحكيم الخاصة. قام الفنان بإنتاج ثلاث نسخ فقط من هذا العمل، وهذه هي النسخة الأولى.",
        images: [
            "/artwork1.jpg",
            "/artwork1-detail1.jpg",
            "/artwork1-detail2.jpg",
            "/artwork1-certificate.jpg",
        ],
        seller: {
...
export default function ArtworkDetailsPage() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-purple-600 text-xl">
                    جاري تحميل بيانات القطعة الفنية...
                </div>
            </div>
        );
    }
            ...
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <div className="text-red-600 text-xl mb-4">
                        عذراً، القطعة الفنية غير موجودة
                    </div>
                    <Link
    ...
    const handleBid = (e: React.FormEvent) => {
        e.preventDefault();
        alert(
            `تم تسجيل مزايدتك بمبلغ ${bidAmount} ريال. سنقوم بالتواصل معك للتأكيد.`
        );
    };
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 mt-6">
                            ...
                            {artwork.certificate && (
                                <div className="mt-4 bg-purple-50 p-4 rounded-lg flex items-start">
                                    <Shield
                                        className="text-purple-600 ml-3 mt-1 flex-shrink-0"
                                        size={20}
                                    />
                                    <div>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <form onSubmit={handleBid} className="space-y-4">
                                <div>
                                    ...
                                    >
                                        قم بإدخال قيمة مزايدتك (بالريال)
                                    </label>
                                    <input
                                        type="number"
                                        id="bid-amount"
                                ...
                                <div className="mr-3">
                                    ...
                                    <div className="flex items-center text-sm text-gray-500">
                                        <span className="text-amber-500 ml-1">
                                            ★ {artwork.seller.rating}
                                        </span>
                                        <span className="mx-1">•</span>
                                        <span>
                                            {artwork.seller.sales} عملية بيع
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {artwork.similarItems.map((item) => (
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <h3 className="font-bold group-hover:text-purple-600 transition">
                                        {item.title}
                                    </h3>
