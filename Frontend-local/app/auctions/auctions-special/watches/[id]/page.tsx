...
export default function WatchDetailPage() {
    ...
    const watchDetails: WatchDetails = {
        ...
        brand: "Rolex",
        description:
            "ساعة رولكس دايتونا كوزموغراف موديل 116500LN، بحالة ممتازة كالجديدة. تم شراؤها من وكيل رولكس الرسمي في دبي عام 2021، ولم تستخدم إلا نادرًا. الساعة مصنوعة من الستانلس ستيل 904L مع إطار سيراميك أسود ومينا أبيض. تحتوي على ميزة الكرونوغراف وعداد تاكيميتر. تأتي مع العلبة الأصلية وجميع الأوراق والضمان الدولي.",
        price: 290000,
        minBid: 295000,
        currentBid: 310000,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        {watchDetails.certificate && (
                            <div className="bg-white rounded-xl shadow-md p-6">
                                <h2 className="text-xl font-bold mb-4">
                                    شهادة الفحص والأصالة
                                </h2>
                                <p className="text-gray-700 mb-4">
                                    تم فحص هذه الساعة والتحقق من أصالتها بواسطة
                                    خبراء معتمدين في مجال الساعات الفاخرة.
                                </p>
                                <Link
                                    href={watchDetails.certificate}
                            ...
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    ...
                                    <div className="text-3xl font-bold text-yellow-600">
                                        {formatPrice(watchDetails.currentBid)}{" "}
                                        ريال
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div className="flex items-center mb-4">
                                ...
                                <div className="mr-3">
                                    ...
                                    <div className="flex items-center text-sm text-gray-500">
                                        ...
                                        <span>
                                            {watchDetails.seller.transactions}{" "}
                                            عملية
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-2 mb-5">
                                ...
                                <div className="flex items-center text-gray-600">
                                    ...
                                    <span>
                                        عضو منذ {watchDetails.seller.joined}
                                    </span>
                                </div>
                            </div>
            ...
            <div className="container mx-auto px-4 mt-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {[1, 2, 3, 4].map((item) => (
                        <Link
                            key={item}
                            href={`/auctions/auctions-special/watches/${item}`}
                            className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition group"
                        >
                            <div className="relative h-48 bg-gray-200"></div>
                            <div className="p-4">
                                <div className="text-lg font-bold group-hover:text-yellow-600 transition">
                                    ساعة مشابهة {item}
                                </div>
                                <div className="text-gray-600 text-sm mb-2">
                                    Rolex / Patek Philippe / AP
                                </div>
