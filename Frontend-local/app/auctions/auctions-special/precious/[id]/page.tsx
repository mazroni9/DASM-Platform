                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            {itemDetails.certificate && (
                                <div className="mt-6 flex items-center p-3 bg-amber-50 rounded-lg">
                                    <Award
                                        size={20}
                                        className="text-amber-600 ml-3 flex-shrink-0"
                                    />
                                    <div>
                                        ...
                                        <Link
                                            ...
                                            className="flex items-center text-amber-600 hover:text-amber-700 mt-1 text-sm"
                                        >
                                            <Download
                                                size={14}
                                                className="ml-1"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div className="bg-amber-50 p-3 rounded-lg flex items-start mb-6">
                                <AlertCircle
                                    size={18}
                                    className="text-amber-600 ml-2 mt-0.5"
                                />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {itemDetails.similarItems.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="text-lg font-bold group-hover:text-amber-600 transition">
                                    {item.title}
                                </div>
