...
// Define the type for the item details
...
export default function ExecutiveItemDetailPage() {
                ...
                <div className="container mx-auto px-4 py-16">
                    <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                        ...
                        <h2 className="text-2xl font-bold mb-4">
                            محتوى مخصص لأعضاء VIP فقط
                        </h2>
                        <p className="text-gray-600 mb-6">
                            هذا المحتوى مخصص للأعضاء المعتمدين في مزادات VIP
                            الخاصة. يرجى طلب دعوة للانضمام للوصول إلى المنتجات
                            الحصرية.
                        </p>
                        <Link
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            {itemDetails.certificate && (
                                <div className="mt-6 flex items-center p-3 bg-purple-50 rounded-lg">
                                    <Award
                                        size={20}
                                        className="text-purple-600 ml-3 flex-shrink-0"
                                    />
                                    <div>
                                        ...
                                        <Link
                                            ...
                                            className="flex items-center text-purple-600 hover:text-purple-700 mt-1 text-sm"
                                        >
                                            <Download
                                                size={14}
                                                className="ml-1"
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-white/80">
                                        هذا المنتج متاح فقط للأعضاء التنفيذيين
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <div className="bg-purple-50 p-3 rounded-lg flex items-start mb-6">
                                <AlertCircle
                                    size={18}
                                    className="text-purple-600 ml-2 mt-0.5"
                                />
                                <div className="text-sm text-purple-800">
                                    <p className="font-medium">
                                        ملاحظة هامة للأعضاء التنفيذيين
                                    </p>
                                    <p>
                                        سيتم التواصل معك مباشرة من قبل مستشار
                                        المزادات الخاص بك بعد المزايدة لتأكيد
                                        العملية وترتيب المعاينة.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {itemDetails.similarItems?.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <div className="text-lg font-bold group-hover:text-purple-600 transition">
                                    {item.title}
                                </div>
