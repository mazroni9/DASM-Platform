/**
 * --------------------------------------
 * 📝 الملف: صفحة تفاصيل المزاد المسجل
 ...
 * 
 * ✅ الوظيفة الرئيسية:
 * - عرض تفاصيل المزاد المسجل الماضي مع فيديو التسجيل الكامل
 * - تشغيل فيديو المزاد مع عرض البيانات المتزامنة والتحكم في الفيديو
 * - عرض قائمة السيارات المباعة في المزاد مع تفاصيلها وأسعارها
 * - عرض الإحصائيات والمؤشرات الرئيسية للمزاد (إجمالي المبيعات، معدل البيع، إلخ)
 * 
 * 🔄 الترابطات:
 * - تستخدم مكون RecordedAuctionPlayer لعرض فيديو المزاد والبيانات المتزامنة
 * - تستخدم مكون AuctionCarList لعرض قائمة السيارات المباعة
 * - ترتبط بقاعدة البيانات للحصول على بيانات المزاد التفصيلية والأحداث
 * - ترتبط بصفحة الأرشيف الرئيسية للعودة إليها
 * - تعرض مزادات مشابهة مرتبطة بنفس النوع أو التصنيف
 * 
 * 🧩 المكونات المستخدمة:
 * - next/navigation: للحصول على معرف المزاد من المسار
 * - lucide-react: للأيقونات
 * - RecordedAuctionPlayer: لعرض الفيديو
 * - AuctionCarList: لعرض قائمة السيارات
