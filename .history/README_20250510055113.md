...
منصة متكاملة للمزادات العربية عبر الإنترنت، مصممة بواجهة مستخدم عربية سلسة وأنيقة.
...
"لعبة المسامير والخشب" هي لعبة ألغاز تفاعلية تحاكي تجربة فك وتركيب قطع الخشب المثبتة بالمسامير والصواميل. اللعبة مستوحاة من لعبة "لغز المسمار: خشب وصامولة"، ولكنها نسخة خالية من الإعلانات وبدون أساليب التشويق والابتزاز للحصول على المال.

## الميزات الرئيسية

- ✅ لعبة ألغاز ذكية بدون إعلانات
- ✅ 30 مستوى بدرجات صعوبة متفاوتة
- ✅ تجربة سلسة وطبيعية لفك المسامير والصواميل
- ✅ رسومات جميلة ومؤثرات صوتية واقعية
- ✅ توافق كامل مع أجهزة الكمبيوتر والأجهزة المحمولة
- ✅ واجهة مستخدم عربية سهلة وواضحة

## كيفية اللعب

1. قم بتدوير وفك المسامير والصواميل بسحبها بحركة دائرية
2. بعد فك جميع المسامير والصواميل المطلوبة، يمكنك سحب قطع الخشب لإكمال المستوى
3. الحل يتطلب إزالة القطع بالترتيب الصحيح، وفي الاتجاه الصحيح
4. تحصل على نجوم بناءً على سرعة إكمال المستوى

## التشغيل المحلي

لتشغيل اللعبة محلياً، اتبع الخطوات التالية:

1. تأكد من وجود خادم ويب محلي (أو استخدم ملحق VS Code مثل "Live Server")
2. افتح ملف `index.html` في المتصفح
3. استمتع باللعب!

## متطلبات التشغيل

- متصفح ويب حديث يدعم HTML5 و JavaScript ES6
- اتصال بالإنترنت لأول مرة فقط (لتحميل مكتبة Phaser)
- لتجربة لعب أفضل على الأجهزة المحمولة، يفضل استخدام أجهزة حديثة

## التطوير المستقبلي

- [ ] إضافة المزيد من المستويات الصعبة والمميزة
- [ ] إضافة المزيد من أنواع المسامير والصواميل وقطع الخشب
- [ ] إضافة نظام تحديات يومية
- [ ] إضافة خيارات تخصيص للألوان وأنماط الخشب

## الترخيص

هذه اللعبة مجانية للاستخدام الشخصي. جميع الحقوق محفوظة.

---

صُنعت بكل حب ❤ بدون إعلانات مزعجة أو عمليات شراء داخل التطبيق. 